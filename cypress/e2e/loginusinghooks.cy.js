...
context('Validate Login Functionality', () => {

    beforeEach('launch url', function() {
        // Steps which need to be executed before each test case
        cy.log("executes before each test block")
        cy.visit('/web/index.php/auth/login')
      });
      
   afterEach('testcomplete', function() {
        // Steps which need to be executed before each test case
        cy.log("this executes after each test block")
      });
      
      
    specify('Verify Login with Valid input details', () => {
      //cy.visit('/web/index.php/auth/login')
